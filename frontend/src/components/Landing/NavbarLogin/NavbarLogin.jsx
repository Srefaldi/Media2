...
const Navbar = () => {
  ...
  return (
    <header className="top-0 left-0 z-10 w-full text-gray-700 bg-white border-b border-gray-200 body-font">
        ...
        <div className="flex items-center md:ml-auto">
          ...
          >
            <div className="hidden w-full md:block md:w-auto">
              <ul className="flex flex-col p-2 mt-2 font-medium border border-gray-100 rounded-lg md:p-0 bg-gray-50 md:space-x-6 md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                  <button
                  ...
                  {dropdownOpen && (
                    <div className="absolute z-10 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-36 dark:bg-gray-700 dark:divide-gray -600">
                      ...
                      <div className="py-1">
                        <button
                          ...
                          className="flex items-center block px-3 py-1 text-xs text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
                        >
