...
function Navbar() {
  useEffect(() => {
    ...
    const toggleMenu = () => {
      let src = (hamburger.src.includes(iconHamburger)) ? iconClose : iconHamburger;
      hamburger.src = src;
    ...
    <nav className="h-22 overflow-hidden" style={{ backgroundColor: '#001F3F' }}>
      <div className="px-6 container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:inline space-x-6 font-semibold">
          <a href="/" className="text-white hover:text-black">Beranda</a>
          <a href="/daftar-materi" className="text-white hover:text-black">Materi</a>
          <a href="/informasi" className="text-white hover:text-black">Informasi</a>
        </div>
        <button className="hidden md:inline px-4 py-2 rounded-3xl font-semibold" style={{ backgroundColor: 'white' }}>
      ...
      <div className="menu absolute container hidden flex-col bg-white shadow-md inset-x-0 mx-auto px-6 py-5">
        ...
        <a className="text-black hover:text-red-500" href="/daftar-materi">Materi</a>
        <a className="text-black hover:text-red-500" href="/informasi">Informasi</a>
