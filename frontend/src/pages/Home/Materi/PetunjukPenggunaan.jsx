...
const PetunjukPenggunaan = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col md:flex-row p-4 md:p-8 gap-6 max-w-7xl mx-auto flex-grow mt-20">
        <nav className="flex flex-col gap-3 w-[256px] bg-white rounded-xl p-4 shadow-lg flex-shrink-0 min-w-[256px]">
          {[
        ...
        <section className="bg-white rounded-xl p-6 md:p-8 flex-1 max-h-[calc(100vh-200px)] overflow-y-auto shadow-lg border border-gray-100 transition-all duration-300 max-w-full">
          {renderContent()}
        </section>
      </main>
      <Footer />
