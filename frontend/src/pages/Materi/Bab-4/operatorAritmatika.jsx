...
const OperatorAritmatika = () => {
  ...
  return (
    <div className="p-4 mb-6 text-justify text-gray-700 bg-white rounded-lg shadow-md">
      ...
      <p className="mb-2">
        Operator Arithmetic (Aritmatika) dalam pemrograman, operasi menggunakan
        informasi numerik dan kemudian menggunakan data tersebut sering terjadi.
        Misalnya, informasi seperti tinggi dan berat badan seseorang dinyatakan
        sebagai nilai numerik seperti 177cm dan 58kg.
      </p>
      <p className="mb-2">
        <strong>
          Sebuah pernyataan pada operasi aritmatika biasanya tersusun dari satu
          atau lebih operand dan satu atau lebih operator yang merepresentasikan
          sebuah ekspresi,{" "}
        </strong>
      ...
      <figure className="p-0 md:p-4 my-3 md:my-0 text-center w-full mt-4">
        <img
          ...
          className="w-full max-w-m2xl mx-auto rounded-lg"
        />
        <div className="mt-3">
      ...
      <p className="mb-2">
        ...
        yang menghasilkan sebuah nilai. Pada gambar di atas, penjumlahan antara
        operand bilangan_1 dan operand bilangan_2 menghasilkan sebuah nilai yang
        kemudian ditetapkan ke dalam variabel hasil. Oleh karena itu, bilangan_1
        + bilangan_2 merupakan sebuah ekspresi.
      </p>
      ...
      <p className="mt-2">
        ...
        seperti tanda plus <code>+</code> untuk operasi penambahan, tanda minus{" "}
        <code>-</code> untuk operasi pengurangan, tanda asterik <code>*</code>{" "}
        untuk operasi perkalian, tanda garis miring <code>/</code> untuk operasi
        pembagian, dan tanda persen <code>%</code> untuk operasi modulus.
      </p>
      <p className="mt-2">
        ...
        <table className="text-center border border-gray-300 w-150">
          <thead className="bg-[#68217A] text-white text-center">
            <tr>
              ...
              <th className="p-2 text-white border border-gray-300">Contoh</th>
      ...
      <p className="mt-2">
        Terdapat prioritas dalam operator-operator di atas. Operator increment,
        decrement, dan minus akan dihitung terlebih dahulu, kemudian baru
        modulus, perkalian dan pembagian, terakhir barulah operator pengurangan
        dan penjumlahan. Jika perlu untuk mengubah urutan eksekusi, tanda kurung
        dapat digunakan.
      </p>
