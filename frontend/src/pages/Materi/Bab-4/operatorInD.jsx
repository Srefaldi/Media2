  ...
  return (
    <div className="p-4 mb-6 text-justify text-gray-700 bg-white rounded-lg shadow-md">
      ...
      <p className="mb-2">
        ...
        <code>a++</code> dan <code>a--</code>. Ini sebenarnya penulisan singkat
        dari operasi <code>a = a + 1</code> serta <code>a = a - 1</code>.
        Increment digunakan untuk menambah variabel sebanyak 1 angka, sedangkan
        decrement digunakan untuk mengurangi sebanyak 1 angka. Penulisannya
        menggunakan tanda tambah dua kali untuk increment, dan tanda kurang dua
        kali untuk decrement. Penempatan tanda tambah atau kurang ini boleh di
        awal seperti <code>++a</code> dan <code>--a</code>, atau di akhir
        variabel seperti <code>a++</code> dan <code>a--</code>.
      </p>
      <p className="mb-2">
        Berikut adalah daftar <strong>operator Increment dan Decrement</strong>{" "}
        dalam C#:
      </p>
      ...
      <p className="mb-2">
        ...
        post-increment yaitu, “Menampilkan nilai a, kemudian ditambah a sebanyak
        1 angka”. Operasi decrement dilakukan oleh variabel <code>int b</code>{" "}
        yang mana di sini melakukan operasi post-decrement yaitu, “Menampilkan
        nilai b, kemudian dikurangi b sebanyak 1 angka”. Kemudian ditampilkan
        menggunakan perintah <code>Console.WriteLine()</code>.
      </p>
