  ...
  return (
    <div className="p-4 mb-6 text-justify text-gray-700 bg-white rounded-lg shadow-md">
      ...
      <p className="mb-2">
        ...
        memberikan tugas pada variabel. Dalam pemrograman C#, operator penugasan
        berguna untuk menetapkan nilai ke variabel. Termasuk operator penugasan
        sederhana (<code>=</code>), serta operator penugasan gabungan seperti{" "}
        <code>+=</code>, <code>-=</code>, <code>*=</code>, dan <code>/=</code>.
        Operator ini tidak hanya memberikan nilai tetapi juga melakukan operasi
        secara bersamaan. Misalnya, operator <code>+=</code> menambahkan operan
        sebelah kanan ke operan sebelah kiri dan menetapkan hasilnya ke operan
        sebelah kiri.
      </p>
      <p className="mb-2">
        ...
        <table className="text-center border border-gray-300">
          <thead className="bg-[#68217A] text-white text-center">
            <tr>
              ...
              <th className="p-2 text-white border border-gray-300">Simbol</th>
            </tr>
          </thead>
          <tbody>
            <tr>
