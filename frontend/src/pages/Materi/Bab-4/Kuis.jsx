  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      ...
      try {
        ...
        const bab4Evaluation = evalResponse.data.find(
          (evaluation) => evaluation.type === "bab" && evaluation.chapter === 4
        );
        if (!bab4Evaluation) {
          setError("Evaluasi untuk Bab 4 tidak ditemukan");
          return;
        }
