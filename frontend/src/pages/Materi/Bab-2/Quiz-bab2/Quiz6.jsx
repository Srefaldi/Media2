    ...
    switch (option) {
      case "B":
        return `Pilihan Anda <strong>${getOptionText(
          option
        )}</strong> salah. Variabel konstanta dengan <code>const</code> tidak dapat berubah nilainya, sedangkan nilai sementara menggunakan variabel biasa. Tinjau kembali materi tentang variabel konstanta di Bab 2. Yuk, coba lagi!`;
      case "C":
        return `Pilihan Anda <strong>${getOptionText(
          option
        )}</strong> tidak tepat. Variabel konstanta tidak terbatas pada satu metode; mereka bersifat tetap di seluruh program. Tinjau kembali materi tentang variabel konstanta di Bab 2. Yuk, coba lagi!`;
      case "D":
        return `Pilihan Anda <strong>${getOptionText(
          option
        )}</strong> tidak benar. Variabel konstanta tidak menyimpan referensi ke objek yang dapat diubah; nilainya harus tetap. Tinjau kembali materi tentang variabel konstanta di Bab 2. Yuk, coba lagi!`;
      case "E":
        return `Pilihan Anda <strong>${getOptionText(
          option
        )}</strong> salah. Variabel konstanta ditentukan saat kompilasi, bukan hanya tersedia saat runtime. Tinjau kembali materi tentang variabel konstanta di Bab 2. Yuk, coba lagi!`;
      default:
        return "Jawaban Anda belum tepat. Silakan baca kembali materi tentang variabel konstanta di Bab 2 dan coba lagi.";
    }
  };
