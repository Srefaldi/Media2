  ...
  return (
    <div className="p-4 mb-6 text-justify text-gray-700 bg-white rounded-lg shadow-md">
      ...
      <p className="mt-4">
        ...
        adalah tipe data yang digunakan untuk merepresentasikan nilai kebenaran
        atau nilai boolean, yaitu nilai yang hanya dapat berupa
        <code>true</code> atau <code>false</code>. Tipe <code>bool</code> sangat
        penting dalam pemrograman untuk melakukan operasi logika, perbandingan,
        dan kontrol alur program.
      </p>
      ...
      <p className="mt-2">
        ...
        <code>18 &lt; 13</code>, yang bernilai false karena 18 lebih besar dari
        13. <code>var2</code> menyimpan hasil perbandingan{" "}
      ...
      <p className="mt-2">
        Dalam kode ini, pengguna memasukkan sebuah angka, lalu program memeriksa
        apakah angka tersebut **genap** menggunakan operasi{" "}
