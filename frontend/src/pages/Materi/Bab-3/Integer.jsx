...
const Integer = () => {
  ...
  return (
    <div className="p-4 mb-6 text-justify text-gray-700 bg-white rounded-lg shadow-md">
      ...
      <p className="mt-4">
        Tipe data integer digunakan untuk menyimpan bilangan bulat, baik positif
        maupun negatif, tanpa desimal seperti: 2, 40, dan -123. Tipe data ini
        sangat umum digunakan dalam pemrograman untuk operasi aritmatika dasar
        dan penghitungan. Dalam bahasa pemrograman C#, terdapat beberapa
        sub-tipe integer yang dibedakan berdasarkan ukuran memori dan jangkauan
        nilainya.
      </p>
      ...
      <p className="mt-2">
        ...
        lain, C# mendukung integer unsigned, yang memungkinkan penggunaan
        seluruh jangkauan nilai positif, yang bisa meningkatkan kapasitas
        penyimpanan.
      </p>
      ...
      <p className="mt-2">
        Pada kode di atas, terdapat deklarasi beberapa variabel dengan berbagai
        tipe data integer. Variabel var1 bertipe sbyte, var2 bertipe byte, var3
        bertipe short, var4 bertipe ushort, var5 bertipe int, var6 bertipe uint,
        var7 bertipe long, dan var8 bertipe ulong. Khusus untuk ulong, nilai
        harus diakhiri dengan karakter UL untuk menunjukkan bahwa itu adalah
        tipe ulong.
      </p>
      ...
      <p className="mt-2">
        Untuk keperluan tertentu, kadang kita butuh mengolah angka dalam sistem
        bilangan biner, oktal, dan heksadesimal. Ini juga bisa ditampung oleh
        tipe data integer dalam bahasa C#.
      </p>
      Deretan Angka Biner
      ...
      <p className="mt-2">
        ...
        <code>0b</code> sebelum penulisan angka, seperti <code>0b10100100</code>
        .
      </p>
      ...
      <p className="mt-2">
        ...
        diambil dari input pengguna menggunakan <code>Console.ReadLine()</code>.
        Input yang dibaca dikonversi ke tipe data integer sebelum disimpan dalam
        variabel.
        <br />
        <br />
        ...
        berbagai sistem bilangan seperti biner, desimal, dan heksadesimal, kita
        dapat lebih mudah melakukan operasi aritmatika dan logika dalam C#.
      </p>
      {/* Kuis */}
      <QuizInteger onComplete={handleQuizComplete} />
      {/* Tombol Navigasi */}
