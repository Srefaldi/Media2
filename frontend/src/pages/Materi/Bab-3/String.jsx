  ...
  return (
    <div className="p-4 mb-6 text-justify text-gray-700 bg-white rounded-lg shadow-md">
      ...
      <p className="mt-2">
        ...
        inisialisasi variabel. String juga dideklarasi dan diinisialisasi dengan
        cara yang sama:
      </p>
      ...
      <p className="mt-2">
        String pada C# sebenarnya adalah sebuah objek, yang berisi properti dan
        fungsi/method yang dapat melakukan operasi tertentu pada string.
...
Console.WriteLine(name); // Output "John Doe" `}
      ...
      <p className="mt-2">
        Kita juga dapat menggunakan method/fungsi <code>string.Concat() </code>
...
Console.WriteLine(myString[1]);  // Output "e"  `}
      ...
      <p className="mt-2">
        Anda juga dapat menemukan posisi indeks karakter tertentu dalam string,
        dengan menggunakan method/fungsi <code>IndexOf()</code>:
      </p>
      <pre className="p-2 font-mono bg-gray-100 rounded">
        <code>
          {`string myString = "Hello"; 
Console.WriteLine(myString.IndexOf("e"));  // Output "1" `}
      ...
      <p className="mt-2">
        ...
        yang mengekstrak karakter dari string, mulai dari posisi/indeks karakter
        yang ditentukan, dan mengembalikan string baru. Method ini sering
        digunakan bersama dengan <code>IndexOf()</code> untuk mendapatkan posisi
        karakter tertentu.
      </p>
      <pre className="p-2 font-mono bg-gray-100 rounded">
        <code>
...
`}
      ...
      <p className="mt-2">
        Backslash (<code>\</code>) escape character mengubah special characters
        menjadi string characters.
      </p>
...
int z = x + y;  // z akan menjadi 30 (sebuah integer/angka) `}
      ...
      <p className="mt-2">
        Namun, jika menambahkan dua buah string, hasilnya akan menjadi rangkaian
        string:
      </p>
      <pre className="p-2 font-mono bg-gray-100 rounded">
        <code>
