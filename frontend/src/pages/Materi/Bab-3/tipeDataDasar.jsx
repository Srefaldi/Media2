  ...
  return (
    <div className="p-4 mb-6 text-justify text-gray-700 bg-white rounded-lg shadow-md">
      ...
      <p className="mt-2">
        ...
        stack, yang membuatnya lebih efisien dalam hal alokasi memori dan akses
        data. Berikut adalah beberapa tipe data nilai dasar yang sering
        digunakan dalam C#:
      </p>
      <ul className="pl-6 list-disc">
        <li>
          <strong>int (Integer)</strong>: Tipe data untuk bilangan bulat seperti
          1, 2, 3.
        </li>
        <li>
        ...
        <li>
          <strong>bool (Boolean)</strong>: Tipe data yang berisi nilai true atau
          false.
        </li>
        <li>
      ...
      <p className="mt-4">
        ...
        <code>var3</code> bertipe <code>double</code>, <code>var4</code> bertipe{" "}
        <code>bool</code>, dan <code>var5</code> bertipe <code>char</code>.
        Setiap variabel menyimpan nilai secara langsung di lokasi memori yang
        dialokasikan untuk variabel tersebut.
      </p>
      ...
      <p className="mt-2">
        Tipe data referensi menyimpan referensi (alamat memori) ke lokasi memori
        yang menyimpan data sebenarnya. Mereka biasanya ditempatkan di heap dan
        lebih fleksibel tetapi memerlukan lebih banyak overhead untuk alokasi
        memori dan pengelolaan. Berikut adalah beberapa tipe data referensi
        dasar yang sering digunakan dalam C#:
      </p>
      <ul className="pl-6 list-disc">
        <li>
