...
const Char = () => {
  ...
  return (
    <div className="p-4 mb-6 text-justify text-gray-700 bg-white rounded-lg shadow-md">
      ...
      <p className="mt-2">
        Tipe data <code>char</code> juga bisa digunakan untuk menyimpan karakter
        angka dan karakter non-alfanumerik. Berikut adalah contohnya:
      </p>
      <pre className="p-2 font-mono bg-gray-100 rounded">
        <code>
      ...
      <p className="mt-2">
        Pada kode di atas, <code>var1</code> menyimpan karakter <code>'5'</code>{" "}
        dan <code>var2</code> menyimpan karakter <code>'$'</code>. Perlu
        diperhatikan bahwa karakter <code>'5'</code> berbeda dengan angka{" "}
        <code>5</code> dari tipe data integer.
      </p>
      <h3 className="mt-4 text-xl font-bold">Karakter Unicode dalam C#</h3>
      <p className="mt-2">
        Tipe data <code>char</code> mendukung karakter Unicode. Karakter Unicode
        dapat diwakili dengan awalan (prefix) <code>\\u</code>, diikuti dengan
        empat digit nomor Unicode heksadesimal. Berikut adalah contoh kode yang
      ...
      <p className="mt-2">
        Tipe data <code>char</code> juga mendukung karakter khusus seperti tanda
        kutip, karakter enter, dan lainnya dengan menggunakan karakter backslash{" "}
        <code>\\</code>, yang disebut sebagai escape character. Berikut adalah
        contoh kode yang menggunakan karakter khusus:
      </p>
      <pre className="p-2 font-mono bg-gray-100 rounded">
        <code>
          {`char var1 = '\''; \nchar var2 = '\\n'; \nchar var3 = '\"'; \n\nConsole.Write(var1); \nConsole.Write(var2); \nConsole.Write(var3);`}
      ...
      <p className="mt-2">
        ...
        <code>\\n</code>, dan karakter tanda kutip dua (<code>"</code>) diwakili
        oleh <code>\\\"</code>. Perhatikan bahwa <code>Console.Write()</code>{" "}
        digunakan untuk menampilkan karakter tanpa baris baru, sehingga karakter
        tanda kutip dua tampil di baris baru karena karakter enter (
        <code>\\n</code>) di atasnya.
      </p>
      ...
      <p className="mt-2">
        ...
        menginisialisasi, dan menggunakan variabel char, kita dapat menulis kode
        yang lebih efektif dan efisien dalam mengelola karakter di dalam program
        kita.
      </p>
