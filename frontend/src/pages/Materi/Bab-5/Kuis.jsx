    ...
    const fetchInitialData = async () => {
      ...
      try {
        ...
        const bab5Evaluation = evalResponse.data.find(
          (evaluation) => evaluation.type === "bab" && evaluation.chapter === 5
        );
        if (!bab5Evaluation) {
          setError("Evaluasi untuk Bab 5 tidak ditemukan");
          return;
        }
      ...
      <div className="p-4 bg-white rounded-lg shadow-md">
        ...
        <section>
          ...
          <p className="mb-3 leading-relaxed">
            Kuis ini bertujuan untuk menguji pengetahuan Anda tentang control
    ...
    if (questions.length === 0 || !questions[currentQuestionIndex]) {
      return (
        <div className="p-4 text-center bg-white rounded-lg shadow-md">
          <h2 className="text-lg font-semibold text-gray-800">KUIS BAB 5</h2>
